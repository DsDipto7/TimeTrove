        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-6 me-5">
                    ...
                    <form class="needs-validation" novalidate="" action="{{url('/_user/edit_cart/'.$getCart->id)}}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control bg-gray-1 fst-italic rounded-0" id="firstName"
                                    placeholder="Write your name here" value="{{$getWatch->title}}" required=""
                                    readonly>

                            </div>
                            <div class="col-12 mb-3">
                                <label for="email" class="form-label">Description</label>
                                <textarea class="form-control bg-gray-1 fst-italic rounded-0"
                                    id="email">{{$getWatch->description}}</textarea>
                            </div>
                            <div class="col-12 mb-3">
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input type="number" class="form-control bg-gray-1 fst-italic rounded-0" id="email"
                                    name="quantity" value="{{$getCart->quantity}}">
                            </div>

                        </div>
                        <input type="submit" class="btn btn-primary btn-lg mt-5 rounded-pill text-uppercase"
                            value="Edit">
                    </form>
                </div>
                <div class="col-lg-5">
                    <div class="row">
                        ...
                        <div class="contact-item">
                            ...
                            <img style="width:30rem;height:20rem;"
                                src="{{asset('TimeTrove/watch/'.$getWatch->photo_path)}}" alt="Watch">
