...
<head>
    <title>Luxury - Free Luxury Watch One Page Website Template</title>
    <meta charset="utf-8">
...
<body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%"
            ...
            <div class="row">
                <div class="col-lg-6 me-5">
                    <div class="display-header">
                        <h2 class="display-2">Add product to cart</h2>
                    </div>
                    @include('auth.message')
                    <form class="needs-validation" novalidate="" action="{{url('/_user/add_to_cart/'.$getWatch->id)}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 mb-3">
                                <label for="firstName" class="form-label">Watch Title</label>
                                <input type="text" class="form-control bg-gray-1 fst-italic rounded-0" id="firstName"
                                    placeholder="Write your name here" value="{{$getWatch->title}}" required="" readonly>
                              
                            </div>
                            <div class="col-12 mb-3">
                                <label for="email" class="form-label">Description</label>
                                <textarea  class="form-control bg-gray-1 fst-italic rounded-0" id="email"
                                    >{{$getWatch->description}}</textarea>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="email" class="form-label">Price</label>
                                <input type="email" class="form-control bg-gray-1 fst-italic rounded-0" id="email"
                                    value="{{$getWatch->price}}">
                            </div>
                            <div class="col-4 mb-3">
                                <label for="email" class="form-label">Quantity</label>
                                <input type="number" class="form-control bg-gray-1 fst-italic rounded-0" id="email" name="quantity" value="0">
                            </div>

                        </div>
                        <input type="submit" class="btn btn-primary btn-lg mt-5 rounded-pill text-uppercase" value="Add">
                    </form>
                </div>
                <div class="col-lg-5">
                    <div class="row">
                        <div class="display-header">
                            <h2 class="display-2">Photo</h2>
                        </div>
                        <div class="contact-item">

                            <img style="width:30rem;height:20rem;" src="{{asset('TimeTrove/watch/'.$getWatch->photo_path)}}" alt="Watch">
                        ...
                        <div class="display-header">
                            ...
                            <div class="social-links">
                                <ul class="list-unstyled d-flex flex-wrap gap-3">
                                    <li>
                                        <a href="#">
                                            <svg width="25" height="25" viewBox="0 0 24 24" class="svg-gray-3">
    ...
    <div class="footer-bottom text-center bg-gray-1 py-5">
        <p>© 2023 Reddy. Designed By <a href="https://templatesjungle.com/">TemplatesJungle</a>
        </p>
    </div>
